...
public abstract class Util {
    ...
    public static File novaMidia(int tipo){
        ...
        File dirMidia = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DCIM),
                PASTA_MIDIA);
        if(!dirMidia.exists()){
            dirMidia.mkdirs();
        }
    ...
    public static void salvarUltimaMidia(Context context, int tipo, String midia){
        SharedPreferences sharedPreferences = context.getSharedPreferences(PREFERENCIA_MIDIA,Context.MODE_PRIVATE);
